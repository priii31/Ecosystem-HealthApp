...
# ====================================================
if page == "Dashboard":
    st.header("Dashboard — Quick Overview")
...
# ====================================================
    ...
    st.header("IoT Simulation — Live Sensor Data")
...
# ====================================================
    ...
    **Machine Learning, Data Visualization, and Real-Time IoT Simulation**.
    ...
    ### 🔍 Key Features:
    - 📊 **Dashboard**: Live ecosystem overview
    - 🔮 **Predictions**: ML-based health predictions
    - 🧠 **Model Training**: Train RandomForest model in-app
    - 📈 **Analytics**: Interactive graphs and heatmaps
    - 📄 **PDF Report Generator**
    - 📡 **IoT Sensor Simulation** (real-time)
